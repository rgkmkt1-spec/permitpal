...
export default function Home() {
  ...
  const restart = () => {
    ...
    setWaitlistEmail(""); setError(""); setEstimate(null);
    setShowEstimateForm(false); setMaterialQuality(""); setLocationType("");
  };
          ...
          <div className="animate-in">
              ...
              <div style={{ background: "#F0F5F2", border: "1px solid #C5D9CE", borderRadius: "10px", padding: "28px", marginTop: "20px", marginBottom: "8px" }}>
                ...
                {showEstimateForm && (
                  <div className="animate-in">
                    ...
                    <button onClick={handleEstimate} disabled={estimateLoading || !materialQuality || !locationType} style={{ background: "#1C3A2F", color: "#E8D5A3", border: "none", padding: "13px 28px", fontSize: "15px", borderRadius: "8px", cursor: !materialQuality || !locationType ? "not-allowed" : "pointer", fontFamily: "sans-serif", fontWeight: 600, opacity: estimateLoading || !materialQuality || !locationType ? 0.5 : 1, width: "100%" }}>
                  ...
                  <div style={{ textAlign: "center" as const }}>
                    {estimateLoading && (
                      <div style={{ marginBottom: "16px" }}>
                        ...
                        <div style={{ fontFamily: "sans-serif", fontSize: "13px", color: "#5A7A6A" }}>This may take up to a minute — we're calculating material costs for your specific project.</div>
                      </div>
                    )}
            ...
            {estimate && (
              <div style={{ ...s.card, marginTop: "20px" }} className="animate-in">
                ...
                {estimate.notes && <div style={s.disclaimer}>{estimate.notes}</div>}
              </div>
            )}
